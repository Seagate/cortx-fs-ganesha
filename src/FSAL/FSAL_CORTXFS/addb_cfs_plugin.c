...
static const struct entity_attrs_items {
  ...
  [PEA_TIME_ATTR_START_NSAL_M0_OP_FINISH] = { .str = "attr_time_start_nsal_m0_op_finish" },
  [PEA_TIME_ATTR_END_NSAL_M0_OP_FINISH] = { .str = "attr_time_end_nsal_m0_op_finish" },
  [PEA_TIME_ATTR_START_NSAL_M0_OP_FREE] = { .str = "attr_time_start_nsal_m0_op_free" },
  [PEA_TIME_ATTR_END_NSAL_M0_OP_FREE] = { .str = "attr_time_end_nsal_m0_op_free" },
  [PEA_TIME_ATTR_START_NSAL_M0_OP_LAUNCH] = { .str = "attr_time_start_nsal_m0_op_launch" },
  [PEA_TIME_ATTR_END_NSAL_M0_OP_LAUNCH] = { .str = "attr_time_end_nsal_m0_op_launch" },
  [PEA_TIME_ATTR_START_NSAL_M0_OP_WAIT] = { .str = "attr_time_start_nsal_m0_op_wait" },
  [PEA_TIME_ATTR_END_NSAL_M0_OP_WAIT] = { .str = "attr_time_end_nsal_m0_op_wait" },
  ...
  [PEA_TIME_ATTR_START_DSAL_M0_OP_FINISH] = { .str = "attr_time_start_dsal_m0_op_finish" },
  [PEA_TIME_ATTR_END_DSAL_M0_OP_FINISH] = { .str = "attr_time_end_dsl_m0_op_finish" },
  [PEA_TIME_ATTR_START_DSAL_M0_OP_FREE] = { .str = "attr_time_start_dsal_m0_op_free" },
  [PEA_TIME_ATTR_END_DSAL_M0_OP_FREE] = { .str = "attr_time_end_dsal_m0_op_free" },
  [PEA_M0_OP_DSAL_SM_ID] = { .str = "pea_m0_op_dsal_sm_id" },
  [PEA_M0_OP_DSAL_SM_STATE] = { .str = "pea_m0_op_dsal_sm_state" },
  ...
  [PEA_TIME_ATTR_START_DSAL_M0_OP_LAUNCH] = { .str = "attr_time_start_dsal_m0_op_launch" },
  [PEA_TIME_ATTR_END_DSAL_M0_OP_LAUNCH] = { .str = "attr_time_end_dsal_m0_op_launch" },
  [PEA_TIME_ATTR_START_DSAL_M0_OP_WAIT] = { .str = "attr_time_start_dsal_m0_op_wait" },
  [PEA_TIME_ATTR_END_DSAL_M0_OP_WAIT] = { .str = "attr_time_end_dsal_m0_op_wait" },
  [PEA_TIME_ATTR_START_DSAL_M0_RC] = { .str = "attr_time_start_dsal_m0_op_rc" },
  [PEA_TIME_ATTR_END_DSAL_M0_RC] = { .str = "attr_time_end_dsal_m0_op_rc" },
...
_Static_assert(ARRAY_SIZE(g_entity_attrs_items_map) < PEAR_END, "Invalid entity attribute");
...
_Static_assert(ARRAY_SIZE(g_function_tag_items_map) < PFTR_END, "Invalid function tag");
